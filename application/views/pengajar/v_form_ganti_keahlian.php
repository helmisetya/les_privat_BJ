  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="row">
           <?php echo form_open('data_diri/simpan_ganti_keahlian','class="form-horizontal"'); ?>
           <div class="box-body">
             <h3 class="box-title">Form Ganti Keahlian</h3>

           <div class="form-group">
           <label for="Nama" class="col-sm-2 control-label">Id Keahlian</label>
            <div class="col-sm-10">
             <input type="text" readonly class="form-control" name="id_keahlian" placeholder="Masukkan Nama anda" value="<?php foreach ($keahliannya as $b) {
               echo $b->id_keahlian;
             } ?>">
            </div>
           </div>
           ...
           <label for="Nama" class="col-sm-2 control-label">Nama</label>
            <div class="col-sm-10">
             <input type="text" readonly class="form-control" name="nama" placeholder="Masukkan Nama anda" value="<?php foreach ($keahliannya as $b) {
               echo $b->nama;
             } ?>">
            </div>
            <input type="hidden" name="id_pengajar" value="<?php foreach ($keahliannya as $b) {
              echo $b->id_pengajar;
            } ?>">
           </div>
           <div class="form-group">
            ...
            <div class="col-sm-10">
            <select name="materi" class="form-control select2 col-sm-10" style="width: 100%;">
