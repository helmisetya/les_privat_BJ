...
<div class="box">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-info">
      ...
      <!-- /.box-header -->
      <!-- form start -->
      <?php echo form_open('pendaftaran/simpan_bio_pgjr','class="form-horizontal"');?>
        <div class="box-body">
        <input type="hidden" class="form-control" name="id_akun" aria-describedby="emailHelp" value="<?php foreach ($akun as $b) { ?> <?php echo $b->id_user; ?> <?php } ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
            <textarea class="form-control" rows="3" placeholder="Masukkan alamat anda di kota Malang" name="alamat"  value="<?php echo set_value('alamat'); ?>"></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
            <textarea class="form-control" rows="3" placeholder="Masukkan alamat asal anda" name="alamat_asal"  value="<?php echo set_value('alamat_asal'); ?>"></textarea>
          </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="jurusan" placeholder="Masukkan jurusan anda"  value="<?php echo set_value('jurusan'); ?>">
