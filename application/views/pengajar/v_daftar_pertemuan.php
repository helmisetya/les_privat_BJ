                ...
                <?php
                    ...
                    foreach ($daftar_pertemuan as $b ) { ?>
                     <tr>
                      ...
                      <td><?php echo '<a class="btn btn-info" href="'.base_url().'index.php/pertemuan/form_isi_pertemuan/'.$b->id_penugasan.'">Isi Berita Acara</a>'?></td>
                     <?php $a++; ?>
                    </tr>
                  <?php  } ?>
                 </tbody>
