    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" readonly class="form-control" name="nama_kons" placeholder="Masukkan Nama anda" value="<?php echo $data_pertemuan->nama_kons; ?>">
          </div>
        </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Nama Siswa</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="nama_siswa" placeholder="Masukkan Nama anda" value="<?php echo $data_pertemuan->nama_peserta; ?>">
            </div>
          </div>
          <div class="form-group">
