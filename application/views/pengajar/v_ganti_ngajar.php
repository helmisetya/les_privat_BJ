  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li >
        ...
        <li class="active">
          <a href="<?php echo base_url('index.php/ganti_jadwal/jadwal_ngajar'); ?>l">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <h3>Daftar mengajar saat ini</h3>
                ...
                <?php
                    ...
                    foreach ($jadwal_ngajar as $b ) { ?>
                     <tr>
                      ...
                      <td><?php echo '<a class="btn btn-warning" href="'.base_url().'index.php/ganti_jadwal/form_ganti_jadwal_ngajar/'.$b->id_penugasan.'">Ganti</a>'?></td>
                     <?php $a++; ?>
                    </tr>
                  <?php  } ?>
                 </tbody>
