               ...
               <div class="box-group" id="accordion">
                 ...
                 <div class="panel box box-primary">
                   ...
                   <div id="collapseOne" class="panel-collapse collapse in">
                     <div class="box-body">
                       <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/data_diri/update_bio_pgjr'); ?>">
                         ...
                         <input type="hidden" name="id_pgjr" value="<?php foreach($bio as $b){
                           echo $b->id_pengajar;
                         } ?>">
                         <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <div class="col-sm-10">
                             <input type="text" class="form-control" name="alamat_asal" value="<?php foreach($bio as $b){
                               echo $b->alamat_asal;
                             } ?>">
                           </div>
                         </div>
                         <div class="form-group">
                           ...
                           <div class="col-sm-10">
                             <select name="kampus" class="form-control select2" style="width: 100%;">
                               ...
                               <option value="UIN">Universitas Islam Negeri Malang</option>
                               <option value="UMM">Universitas Muhammdiyah Malang</option>
                               <option value="ITN">ITN</option>
                               <option value="Poltek">Politeknik Negeri Malang</option>
                               <option value="STIKI">STIKI Malang</option>
                               <option value="Unikama">Universitas Kanjuruhan Malang</option>
                               <option value="Gajayana">Universitas Gajayana Malang</option>
                         ...
                         <div class="form-group">
                           ...
                           <div class="col-sm-10">
                             <input type="text" class="form-control" name="semester" value="<?php foreach($bio as $b){
                               echo $b->semester;
                             } ?>">
                           </div>
                         </div>
                         <div class="form-group">
                           ...
                           <div class="col-sm-10">
                             <input type="text" class="form-control" name="jurusan" value="<?php foreach($bio as $b){
                               echo $b->jurusan;
                             } ?>">
                           </div>
                         </div>
                         ...
                         <div class="form-group">
                           <div class="col-sm-offset-2 col-sm-10">
                             <a href="<?php echo base_url('index.php/pengajar/update_keahlian'); ?>" class="btn btn-danger">Ganti</a>
                 ...
                 <div class="panel box box-danger">
                   ...
                   <div id="collapseTwo" class="panel-collapse collapse">
                     <div class="box-body">
                       ...
                       <div class="form-group">
                         <div class="col-sm-offset-2 col-sm-10">
                           <a href="<?php echo base_url('index.php/data_diri/update_keahlian')?>" class="btn btn-danger">Ganti</a>
                         </div>
                       </div>
                     </div>
                   </div>
                 ...
                 <div class="panel box box-warnig">
                   ...
                   <div id="collapseThree" class="panel-collapse collapse">
                     ...
                     <div class="form-group">
                       <div class="col-sm-offset-2 col-sm-10">
                         <a href="<?php echo base_url('index.php/data_diri/update_waktu')?>" class="btn btn-danger">Ganti</a>
                       </div>
                     </div>
                   </div>
                 </div>
