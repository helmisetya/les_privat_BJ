  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="row">
           <?php echo form_open('data_diri/simpan_ganti_waktu','class="form-horizontal"'); ?>
           <div class="box-body">
             <h3 class="box-title">Form Ganti Waktu Mengajar</h3>

           <div class="form-group">
           <label for="Nama" class="col-sm-2 control-label">Id Waktu Mengajar</label>
            <div class="col-sm-10">
             <input type="text" readonly class="form-control" name="id_waktu_ngajar" placeholder="Masukkan Nama anda" value="<?php foreach ($waktunya as $b) {
               echo $b->id_waktu_ngajar;
             } ?>">
            </div>
           </div>
           <input type="hidden" name="id_pengajar" value="<?php foreach ($waktunya as $b) {
             echo $b->id_pengajar;
           } ?>">
           <div class="form-group">
           <label for="Nama" class="col-sm-2 control-label">Nama</label>
            <div class="col-sm-10">
             <input type="text" readonly class="form-control" name="nama" placeholder="Masukkan Nama anda" value="<?php foreach ($waktunya as $b) {
               echo $b->nama;
             } ?>">
            </div>
           </div>
           <div class="form-group">
            ...
            <div class="col-sm-10">
            <select name="hari" class="form-control select2 col-sm-10" style="width: 100%;">
           ...
           <div class="form-group">
            <label class="col-sm-2 control-label">Pilih Waktu</label>
            <div class="col-sm-10">
            <select name="waktu" class="form-control select2 col-sm-10" style="width: 100%;">
              ...
              <small>Pada hari senin - jumat, opsi waktu mengajar pukul 08:00 - 10:00 Tidak akan di simpan</small>
            </div>
           </div>
        </div>
