  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <?php echo form_open('ganti_jadwal/simpan_ganti_ngajar','class="form-horizontal"');?>
              <div class="box-body">

              <input type="hidden" name="id_konsumen" value="<?php echo $ganti_jadwal_ngajar->id_kons; ?>">
              <input type="hidden" name="id_pengajar" value="<?php echo $ganti_jadwal_ngajar->id_pengajar; ?>">

               <div class="form-group">
                  <label for="Nama"  class="col-sm-2 control-label">Id Penugasan</label>
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="id_penugasan" placeholder="Masukkan Nama Anak anda"  value="<?php echo $ganti_jadwal_ngajar->id_penugasan ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="nama_siswa" placeholder="Masukkan Nama Anak anda"  value="<?php echo $ganti_jadwal_ngajar->nama_kons ?>">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="materi" placeholder="Masukkan Nama Anak anda"  value="<?php echo $ganti_jadwal_ngajar->materi?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="hari" placeholder="Masukkan Nama Anak anda"  value="<?php echo $ganti_jadwal_ngajar->hari ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control" name="jam" placeholder="Masukkan Nama Anak anda"  value="<?php echo $ganti_jadwal_ngajar->jam ?>">
