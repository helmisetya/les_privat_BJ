                     ...
                     <div class="box-body">
                       <table id="keahlian" class="table table-bordered table-striped">
                         ...
                         <?php
                             ...
                             foreach ($waktu as $b ) { ?>
                              <tr>
                               <td><?php echo $b->id_waktu_ngajar;  ?></td>
                               <td><?php echo $b->hari; ?></td>
                               <td><?php echo $b->waktu; ?></td>
                               <td><?php echo '<a class="btn btn-warning" href="'.base_url().'index.php/data_diri/form_ganti_waktu/'.$b->id_waktu_ngajar.'">Ganti</a>'?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="" class="btn btn-danger" data-toggle="modal" data-target="#modal-hapus">Hapus</a>
                             </tr>
                           <?php  } ?>
                       ...
                       <a class="btn btn-info" href="<?php echo base_url('index.php/data_diri/form_tambah_waktu')?>">Tambah Waktu Mengajar</a>
                     </div>
                   </div>
                 </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <?php echo '<a class="btn btn-outline" href="'.base_url().'index.php/data_diri/hapus_waktu/'.$b->id_waktu_ngajar.'">Ya, Hapus</a>'?>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
