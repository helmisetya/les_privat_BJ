...
<div class="box">
  ...
  <div class="col-md-12">
    ...
    <div class="box box-info">
      ...
      <!-- /.box-header -->
      <!-- form start -->
      <?php echo form_open('pendaftaran/simpan_keahlian','class="form-horizontal"');?>
        <div class="box-body">
        <input type="hidden" class="form-control" name="id_pgjr" aria-describedby="emailHelp" value="<?php echo $pgjr->id_pengajar; ?>">
          ...
          <div class="form-group">
                <label for="materi" class="col-sm-2 control-label" >Pilih Materi</label>
                <div class="col-sm-10">
                <div class="form-check">

                  <?php echo form_checkbox('materi[]','IPA SD', set_checkbox('materi[]','IPA SD', 'false')); ?>
                  IPA SD <br>
                  <?php echo form_checkbox('materi[]','MATEMATIKA SD', set_checkbox('materi[]','MATEMATIKA SD', 'false')); ?>
                  MATEMATIKA SD <br>
                  <?php echo form_checkbox('materi[]','BAHASA INGGRIS SD', set_checkbox('materi[]','BAHASA INGGRIS SD', 'false')); ?>
                  BAHASA INGGRIS SD <br>
                  <?php echo form_checkbox('materi[]','IPA SMP', set_checkbox('materi[]','IPA SMP', 'false')); ?>
                  IPA SMP <br>
                  <?php echo form_checkbox('materi[]','MATEMATIKA SMP', set_checkbox('materi[]','MATEMATIKA SMP', 'false')); ?>
                  MATEMATIKA SMP <br>
                  <?php echo form_checkbox('materi[]','BAHASA INGGRIS SMP', set_checkbox('materi[]','BAHASA INGGRIS SMP', 'false')); ?>
                  BAHASA INGGRIS SMP <br>
                </div>
              </div>
              </div>
        <!-- /.box-body -->
