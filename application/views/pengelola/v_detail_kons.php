                   ...
                   <div class="box-group" id="accordion">
                     ...
                     <div class="panel box box-primary">
                       ...
                       <div id="collapseOne" class="panel-collapse collapse in">
                         <div class="box-body">
                           <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/master/update_status_kons'); ?>">
                             <input type="hidden" name="id_konsumen" value="<?php foreach($bio as $b){
                               echo $b->id_konsumen;
                             } ?>">
