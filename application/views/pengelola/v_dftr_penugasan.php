              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    ...
                    foreach ($penugasan as $b ) { ?>
                     <tr>
                      <td><?php echo $a;  ?></td>
                      <td><?php echo $b->id_penugasan; ?></td>
                      <td><?php echo $b->nama_kons; ?></td>
                      <td><?php echo $b->nama_pgjr; ?></td>
                      <td><?php echo $b->materi; ?></td>
                      <td><?php echo $b->hari; ?></td>
                      <td><?php echo $b->jam; ?></td>
                      <td>
                        <?php if( $b->waktu_habis >= 1) {?>
                          <font color="red"><?php echo $b->waktu_habis; ?> Hari</color>
                        <?php }
                       else{ ?>
                          <font color="black"><?php echo $b->waktu_habis; ?> Hari</color>
                        <?php } ?>

                      </td>
                      <td><?php echo $b->status; ?></td>
                      <td><?php echo '<a class="btn btn-warning" href="'.base_url().'index.php/master/detail_penugasan/'.$b->id_penugasan.'">Edit</a>'?></td>
                     <?php $a++; ?>
                    </tr>
                  <?php  } ?>
                 </tbody>
