...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Permintaan Pergantian Jadwal Mengajar
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <?php echo form_open('ganti_jadwal/simpan_acc_ganti_ngajar','class="form-horizontal"');?>
        <div class="box-body">
          <h3>Form Acc Pergantian Jadwal Mengajar</h3>
          <input type="hidden" name="id_ganti_pgjr" value="<?php echo $acc_ganti_ngajar->id_ganti_pgjr; ?>">

          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Id Penugasan Lama</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="id_penugasan_lama" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_ngajar->id_penugasan_lama; ?>">
            </div>
          </div>
          <input type="hidden" name="id_kons" value="<?php echo $acc_ganti_ngajar->id_kons; ?>">
          <input type="hidden" nae="id_pgjr" value="<?php echo $acc_ganti_ngajar->id_pgjr; ?>">
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Nama Konsumen</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="nama_konsumen" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_ngajar->nama_siswa; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Nama Pengajar Lama</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="nama_pgjr" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_ngajar->nama; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Materi</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="materi" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_ngajar->materi_penugasan; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Hari</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="hari" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_ngajar->hari_penugasan; ?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="jam" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_ngajar->jam_penugasan; ?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
            <input type="text" readonly class="form-control" name="alasan" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_ngajar->alasan; ?>">
          </div>
