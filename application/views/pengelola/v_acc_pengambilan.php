...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Acc Pengambilan Tugas Oleh Pengajar
      </h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <?php echo form_open('penugasan/simpan_acc','class="form-horizontal"');?>
        <div class="box-body">
          <h3>Form Acc Pengambilan Tugas</h3>
        <input type="hidden" name="id_penugasan" value="<?php echo $acc->id_penugasan; ?>">
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Id Pesanan</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="id_pesanan" placeholder="Masukkan Nama anda" value="<?php echo $acc->id_pesan; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Nama Pengajar</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="nama_pgjr" placeholder="Masukkan Nama anda" value="<?php echo $acc->nama; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Nama Konsumen</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="nama_konsumen" placeholder="Masukkan Nama anda" value="<?php echo $acc->nama_kons; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Tanggal Pesan</label>
            <div class="col-sm-10">
              <input type="date" readonly class="form-control" name="tanggal_pesan" placeholder="Masukkan Nama anda" value="<?php echo $acc->tgl_pesan; ?>">
            </div>
          </div>
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control select2" style="width: 100%;">
              ...
              <option value="Tidak Aktif">Tidak di terima</option>
             </select>
           </div>
        </div>
