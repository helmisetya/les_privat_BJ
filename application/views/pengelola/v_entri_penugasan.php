      ...
      <li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i>Belum Terambil</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <?php echo form_open('penugasan/simpan_penugasan','class="form-horizontal"');?>
        <div class="box-body">
          <h3>Form Entri Penugasan</h3>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Id Pesanan</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="id_pesanan" placeholder="Masukkan Nama anda" value="<?php echo $pesannya->id_pesan; ?>">
            </div>
          </div>

          <input type="hidden" class="form-control" name="id_kons" value="<?php echo $pesannya->id_konsumen; ?>" >
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Nama Konsumen</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="nama_konsumen" placeholder="Masukkan Nama anda" value="<?php echo $pesannya->nama; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Materi</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="materi" placeholder="Masukkan Nama anda" value="<?php echo $pesannya->materi; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Hari</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="hari" placeholder="Masukkan Nama anda" value="<?php echo $pesannya->hari; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Jam</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="jam" placeholder="Masukkan Nama anda" value="<?php echo $pesannya->jam; ?>">
            </div>
          </div>

          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Tanggal Pesan</label>
            <div class="col-sm-10">
              <input type="date" readonly class="form-control" name="tanggal_pesan" placeholder="Masukkan Nama anda" value="<?php echo $pesannya->tgl_pesan; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Tempat Pertemuan</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="tempat_pertemuan" placeholder="Masukkan Nama anda" value="<?php echo $pesannya->tempat_pertemuan; ?>">
            </div>
          </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
          <input type="date" class="form-control" value="<?php echo set_value('tgl_mulai'); ?>" name="tgl_mulai"  >
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
          <input type="date" class="form-control" value="<?php echo set_value('tgl_selesai'); ?>" name="tgl_selesai"  >
