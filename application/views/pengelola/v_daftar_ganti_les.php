  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <h3>Daftar Permintaan Pergantian Les</h3>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Nomor</th>
                      <th>Id Penugasan Lama</th>
                      <th>Nama </th>
                      <th>Materi yang di minta</th>
                      <th>Aksi</th>
                </tr>
                </thead>
                <tbody>
                <?php
                    $a = 1;
                    foreach ($ganti_les as $b ) { ?>
                     <tr>
                      <td><?php echo $a;  ?></td>
                      <td><?php echo $b->id_penugasan_lama; ?></td>
                      <td><?php echo $b->nama; ?></td>
                      <td><?php echo $b->materi; ?></td>
                      <td><?php echo '<a class="btn btn-info" href="'.base_url().'index.php/ganti_jadwal/form_acc_ganti_les/'.$b->id_penugasan_lama.'">Detail</a>'?></td>
                     <?php $a++; ?>
                    </tr>
                  <?php  } ?>
                 </tbody>
