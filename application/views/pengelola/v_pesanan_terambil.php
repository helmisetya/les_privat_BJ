      ...
      <li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Sudah Terambil</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <h3>Daftar Pesanan Sudah Terambil</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  <tr>
                      ...
                      <td><?php echo '<a class="btn btn-info" href="'.base_url().'index.php/penugasan/acc_pengambilan/'.$b->id_pesan.'">Detail</a>'?></td>
                    </tr>
                  <?php $a++; ?>
                <?php  } ?>
                 </tbody>
