              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    ...
                    foreach ($pgjr as $b ) { ?>
                     <tr>
                      <td><?php echo $a;  ?></td>
                      <td><?php echo $b->id_pengajar; ?></td>
                      <td><?php echo $b->nama; ?></td>
                      <td><?php echo $b->tgl_dftr; ?></td>
                      <td><?php echo $b->status; ?></td>
                      <td><?php echo '<a class="btn btn-info" href="'.base_url().'index.php/Master/detail_pengajar/'.$b->id_pengajar.'">Detail</a>'?></td>
                     <?php $a++; ?>
                    </tr>
                  <?php  } ?>
                 </tbody>
