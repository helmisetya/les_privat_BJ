...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Permintaan Pergantian Jadwal Les
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <?php echo form_open('ganti_jadwal/simpan_acc_ganti_les','class="form-horizontal"');?>
        <div class="box-body">
          <h3>Form Acc Pergantian Jadwal Les</h3>
          <input type="hidden" name="id_ganti_kons" value="<?php echo $acc_ganti_les->id_ganti_kons; ?>">

          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Id Penugasan Lama</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="id_penugasan_lama" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->id_penugasan_lama; ?>">
            </div>
          </div>

              <input type="hidden"  class="form-control" name="id_pesan_lama" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->id_pesan_lama; ?>">
            
          <input type="hidden" name="id_kons" value="<?php echo $acc_ganti_les->id_konsumen; ?>">

          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Nama Konsumen</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="nama_konsumen" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->nama; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Materi</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="materi" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->materi; ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Hari</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="hari" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->hari; ?>">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="jam" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->jam; ?>">
            </div>
          </div>

          <div class="form-group">
            <label for="Nama" class="col-sm-2 control-label">Tempat Pertemuan</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="tempat_pertemuan" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->tempat_pertemuan; ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Alasan</label>
            <div class="col-sm-10">
              <input type="text" readonly class="form-control" name="alasan" placeholder="Masukkan Nama anda" value="<?php echo $acc_ganti_les->alasan; ?>">
          </div>
          </div>
          <div class="form-group">
          <label class="col-sm-2 control-label">Tanggal Mulai</label>
          <div class="col-sm-10">
          <input type="date" readonly class="form-control" value="<?php echo $acc_ganti_les->tgl_mulai_penugasan ?>" name="tgl_mulai"  >
        </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label">Tanggal Selesai</label>
          <div class="col-sm-10">
          <input type="date" readonly class="form-control" value="<?php echo $acc_ganti_les->tgl_selesai_penugasan ?>" name="tgl_selesai"  >
        </div>
        </div>

        <div class="form-group">
            <label class="col-sm-2 control-label">Pilih Pengajar</label>
            <div class="col-sm-10">
            <select name="id_pgjr" class="form-control select2" style="width: 100%;">
              <?php
              foreach ($dftr_pgjr as $b) {
              ?>
              <option value="<?php echo $b->id_pengajar ?>"> <?php echo $b->nama; ?> , Id Pengajar : <?php echo $b->id_pengajar ?> </option>
              <?php } ?>
                  ?>
             </select>
           </div>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Tanggal Acc</label>
          <div class="col-sm-10">
          <input type="date" readonly class="form-control" value="<?php echo tanggal(); ?>" name="tgl_acc"  >
        </div>
        </div>
        <div class="form-group">
