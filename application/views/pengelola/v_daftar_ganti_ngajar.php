...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Permintaan Ganti Jadwal Mengajar
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <h3>Daftar Permintaan Pergantian Pengajar</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    $a = 1;
                    foreach ($ganti_ngajar as $b ) { ?>
                     <tr>
                      <td><?php echo $a;  ?></td>
                      <td><?php echo $b->id_penugasan_lama; ?></td>
                      <td><?php echo $b->nama; ?></td>
                      <td><?php echo $b->nama_siswa; ?></td>
                      <td><?php echo '<a class="btn btn-info" href="'.base_url().'index.php/ganti_jadwal/form_acc_ganti_ngajar/'.$b->id_penugasan_lama.'">Detail</a>'?></td>
                     <?php $a++; ?>
                    </tr>
                  <?php  } ?>
                 </tbody>
