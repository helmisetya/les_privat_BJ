         ...
         <div class="box-body">
          <h3>Jadwal Les Saat Ini</h3>
                ...
                <?php
                    ...
                    foreach ($jadwal_les as $b ) { ?>
                     <tr>
                      ...
                      <td><?php echo '<a class="btn btn-warning" href="'.base_url().'index.php/ganti_jadwal/form_ganti_jadwal_les/'.$b->id_penugasan.'">Ganti</a>'?></td>
                     <?php $a++; ?>
                    </tr>
                  <?php  } ?>
                 </tbody>
            ...
            <div class="callout callout-info">
                ...
                <p>Pergantian jadwal les hanya bisa di lakukan sebanyak 1 kali</p>
              </div>
        </div>
      <!-- /.box -->
